...
\newcommand{\myeqp}[1]{\hyperref[eq:#1]{Eq.\ref*{eq:#1}}}
...
\newcommand{\myalg}[1]{\hyperref[alg:#1]{Algorithm~\ref*{alg:#1}}}
\newcommand{\mytheorem}[1]{\hyperref[theorem:#1]{Theorem~\ref*{theorem:#1}}}
\newcommand{\myfootnote}[1]{\hyperref[footnote:#1]{Footnote~\ref*{footnote:#1}}}
